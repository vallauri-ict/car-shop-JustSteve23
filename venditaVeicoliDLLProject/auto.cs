...
namespace venditaVeicoliDLLProject
{
    ...
    public class auto:veicolo
    {
        ...
        public auto() : base("BMW", "Z4", 2000, 200, new DateTime(), 0, "nero", false, false,50000) { NumairBag = 6; }
        public auto(string marca, string modello, int cilindrata, int potenza, DateTime dataImm,
            int chilometriPercorsi, string colore, bool usato, bool kmZero,double prezzo,int numairBag) : base(marca, modello, cilindrata,
