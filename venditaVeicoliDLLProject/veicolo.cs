...
namespace venditaVeicoliDLLProject
{
    ...
    public abstract class veicolo
    {
        ...
        public veicolo(string marca, string modello, int cilindrata, double potenzaKw, DateTime immatricolazione, int kmPercorsi, string colore, bool isUsato, bool isKmZero,double prezzo)
        {
            this.Marca = marca;
